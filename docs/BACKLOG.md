...
**Status: 27 of 30 rows done** (plus 8c-1 and 8c-2, which shipped before this file existed). What is left: one human task (8d-5, the walkthrough recording) and two items in the R series.
