...
- **Status:** **open — the most important gap in the slice as it stands.** Decided 2026-09-22 (gate G-4 in [BACKLOG-channels.md](BACKLOG-channels.md)): refuse to price a channel the price list cannot serve (C-32, not yet built), then per-channel price lists as their own phase. Until C-32 lands, the behaviour below is what runs.
