...
export type TenantCapabilitiesQuery = { __typename?: 'Query', capabilities: { __typename?: 'CapabilitiesType', currency: string, currencyMinorUnits: number, defaultLocale: string, channel?: { __typename?: 'ChannelCapabilities', key: string, name: string, isDefault: boolean, currency: string, currencyMinorUnits: number, defaultLocale: string } | null } };
